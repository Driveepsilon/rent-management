...
import { Plus, Receipt, FileText, DollarSign, Calendar, User, Mail, Download } from 'lucide-react';
...
const ReceiptManagementWithPDF: React.FC = () => {
  ...
  const generateReceiptPDF = (payment: Payment) => {
    ...
    try {
      pdfGenerator.generateReceiptPDF(payment, tenant, invoice);
      toast({
        title: "PDF Generated",
